        ...
        <>
            ...
            <aside className={`fixed top-0 left-0 h-full w-64 bg-white shadow-lg transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 transition-transform duration-300 ease-in-out z-10`}>
                <div className="p-4 border-b">
                    <h2 className="text-2xl font-bold text-black">Theater Panel</h2>
                </div>
                <nav className="p-4">
                    <ul>
                        <li className="mb-2">
                            <NavLink to="/theater/shows" className={navLinkClasses}>Manage Shows</NavLink>
                        </li>
                         <li className="mb-2">
